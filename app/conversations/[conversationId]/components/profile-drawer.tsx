...
const ProfileDrawer: React.FC<ProfileDrawerProps> = ({
  ...
  const handleCopy = () => {
    write(otherUser.email!)
      ...
      .catch((reason: any) => {
        toast.error(`Copy failed, ${JSON.stringify(reason)}`);
      });
  };
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <div className="flex gap-10 my-8">
                            ...
                            >
                              ...
                              <div className="text-sm font-light group-hover:text-primary">
                                Delete
                              </div>
                            </div>
                          </div>
                          <div className="w-full pb-5 pt-5 sm:px-0 sm:pt-0 select-none">
                            <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                              ...
                              {!data.isGroup && (
                                <div>
                                  ...
                                  <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 flex justify-between items-center select-none">
                                    {otherUser.email}
                                    <Button
                                      size="sm"
                                      type="ghost"
                              ...
                              {!data.isGroup && (
                                <>
                                  ...
                                  <div>
                                    ...
                                    <dd className="mt-1 text-sm  text-gray-900 sm:col-span-2 select-none">
